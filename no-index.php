...
$page_title = "Sin Página de Inicio | SisGesNom";
...
<div class="container">
    <header class="top">
        ...
        <div class="headline">
            ...
            <div class="badges">
                ...
                <span>Sin p&aacute;gina de inicio</span>
            </div>
        </div>
    </header>
    ...
    <div class="wizard">
        <div class="modal-titlebar">
            <i class="fa-solid fa-house-crack tt-icon"></i>
            <span class="tt-text">Sin P&aacute;gina de Inicio</span>
        </div>
        <div class="step-body">
            <div class="error-header">
                <i class="fa-solid fa-house-crack"></i>
                <h2>Sin P&aacute;gina de Inicio</h2>
            </div>
            <div class="alert error show">
                <b>Error 403 - Sin p&aacute;gina de inicio</b> 
                No se ha encontrado el archivo <b>index.php</b> en la ra&iacute;z del sitio. 
                El listado de directorios ha sido bloqueado para proteger la integridad del servidor.
            </div>

            <h2 class="panel-title">&iquest;Qu&eacute; ocurri&oacute;?</h2>
            <p class="panel-desc">
                El servidor intent&oacute; mostrar la p&aacute;gina de inicio pero no encontr&oacute;
                ning&uacute;n archivo de &iacute;ndice (index.php o index.html).
                Cree y suba un archivo <b>index.php</b> a la ra&iacute;z del sitio para que este mensaje desaparezca.
            </p>
