...
/* ============================================================
   RESPONSIVE GLOBAL — Ficha de Costo Impresión A4
   ============================================================ */
...
/* El bloque azul con el texto del servicio */
#pantallaBienvenida > .contenido-bienvenida > div[style*="font-size:1.3rem"] {
    font-size: clamp(0.85rem, 3vw, 1.3rem) !important;
    padding: clamp(0.5rem, 2vw, 0.8rem) clamp(0.8rem, 3vw, 1.5rem) !important;
    max-width: 100%;
    word-break: break-word;
}
/* Logos fondo rotando */
...
/* Ficha (tablas) — scroll horizontal en móvil */
.ficha-container {
    padding: clamp(10px, 2.5vw, 20px);
    overflow-x: auto;
...
/* El anexo también necesita scroll */
.anexo-container { overflow-x: auto; -webkit-overflow-scrolling: touch; }
.anexo-container table.ficha { min-width: 520px; }
