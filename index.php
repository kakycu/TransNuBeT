...
try {
    ...
    if ($conn->connect_error) {
        ...
        if ($checkTable && $checkTable->num_rows > 0) {
            $configQuery = $conn->query("SELECT parametro, valor FROM configuracion_general WHERE parametro IN ('nombre_empresa', 'site_name')");
            if ($configQuery) {
...
<head>
    ...
    <title>PDL TransNuBeT - Centro de Control · v2.0.1</title>
...
<div class="dashboard-container">
    <div class="modern-header">
        <div class="logo-area">
            <div class="logo-icon">
                <img src="images/logotn.png" alt="PDL TransNuBeT Logo" 
                     style="width: 100%; height: 100%; object-fit: contain;"
                     onerror="this.onerror=null; this.style.display='none'; this.parentElement.innerHTML='<i class=\'fas fa-cloud-moon\'></i>';">
            </div>
            <div class="logo-text">
                <h2>PDL TransNuBeT · Transformando Nuevitas en beneficio de todos.</h2>
                <span style="font-size: 18px">Plataforma de Desarrollo de Subsistemas · v2.0.1</span>
            </div>
        </div>
        <div class="header-badge">
            ...
            <div class="custom-dropdown" id="otrosServiciosDropdown">
                ...
                <div class="custom-dropdown-menu" id="dropdownMenu">
                    <div class="dropdown-title">Servicios Generakes</div>
    ...
    <div class="unified-footer-card">
        <div class="footer-main">
            <div class="footer-brand">
                <i class="fas fa-shield-hawk"></i>
                <div class="brand-text">
                    <h4>PDL TransNuBeT</h4>
                    <p>Proyecto de Desarrollo Local · Transformando Nuevitas en beneficio de todos.</p>
                </div>
            </div>
    ...
    if (!serverOk) {
        Swal.fire({
            ...
            html: `No es posible acceder porque el servidor (PHP/MySQL) no está funcionando correctamente.<br><br>
                   📱 <strong>Móvil Empresarial:</strong> <a href="tel:+5359860773" style="color:#60a5fa;">+53 5 2712861</a><br>
                   ✉️ <strong>Email:</strong> <a href="mailto:admin_sistemasTransNuBeT@gmail.com" style="color:#60a5fa;">admin_sistemasTransNuBeT@gmail.com</a><br><br>
            ...
            Swal.fire({
                ...
                html: `
                    <div style="text-align: left;">
                        ...
                        <p><strong>Base de datos:</strong> TransNuBeT_DB</p>
...
function mostrarBienvenida() {
    ...
    if (!justRedirected) {
        setTimeout(() => {
            Swal.fire({
                title: '✨ Bienvenido al Ecosistema Financiero de PDL TransNuBeT',
                html: '<span style="font-size:0.95rem;">Centro de Control Empresarial v2.0.1<br><br><span style="animation: blink 1s step-start infinite; font-weight: 700; color: #3b82f6;">🔽 SELECCIONE UNO DE LOS SUBSISTEMAS A UTILIZAR.</span><br><br><i class="fas fa-chart-line"></i> Nóminas | <i class="fas fa-file-invoice-dollar"></i> Facturación<br><i class="fas fa-chart-pie"></i> Costos | <i class="fas fa-boxes"></i> Inventarios | <i class="fas fa-user-cog"></i> Administración</span>',
                icon: 'info',
                background: '#0f172a',
                color: '#e2e8f0',
                iconColor: '#3b82f6',
    ...
    function initDropdown() {
        ...
        dropdownMenu.querySelectorAll('.dropdown-item').forEach(item => {
            item.addEventListener('click', function(e) {
                ...
                // Acción para "charangon": redirigir a la nueva ruta
                if (servicio === 'charangon') {
                ...
                Swal.fire({
                    ...
                    html: `
                        <div style="text-align: left;">
                            ...
                            <br>
                            📱 <strong>Móvil Empresarial:</strong> <a href="tel:+5359860773" style="color:#60a5fa;">+53 5 2712861</a><br>
                            ✉️ <strong>Email:</strong> <a href="mailto:admin_sistemasTransNuBeT@gmail.com" style="color:#60a5fa;">admin_sistemasTransNuBeT@gmail.com</a>
                        </div>
                    `,
                    icon: 'warning',
                    background: '#0f172a',
