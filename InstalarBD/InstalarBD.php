...
/* ============================================================
   RESPONSIVE GLOBAL — InstalarBD.php
   Cubre PC grande, tablet, móvil y móvil pequeño
   ============================================================ */

/* ---------- Tablet horizontal / PC pequeño ---------- */
@media (max-width: 1100px) {
    .container { max-width: min(920px, 96vw); }
    .form-grid.grid-empresa { grid-template-columns: repeat(4, 1fr); }
    .form-grid.grid-empresa .form-group.col-3 { grid-column: span 2; }
}
@media (max-width: 960px) {
    .req-list { grid-template-columns: repeat(3, 1fr); }
    .form-grid.grid-empresa { grid-template-columns: repeat(3, 1fr); }
    .form-grid.grid-empresa .form-group.col-2,
    .form-grid.grid-empresa .form-group.col-3 { grid-column: span 3; }
}
...
/* ---------- Tablet vertical ---------- */
@media (max-width: 820px) {
    body { padding: clamp(12px, 3vw, 20px) clamp(8px, 2vw, 14px) clamp(32px, 5vw, 50px); }
    ...
    .form-grid.grid-empresa .form-group.col-3 { grid-column: 1 / -1; }
    .summary { grid-template-columns: 1fr; }
    .modal-logo { height: clamp(140px, 28vw, 220px); max-width: 90vw; }
    .modal-heading .hh { font-size: clamp(18px, 4.5vw, 26px); }
    .modal-heading .ss { font-size: clamp(12px, 2.8vw, 14px); }
}

/* ---------- Móvil horizontal / tablet pequeña ---------- */
@media (max-width: 640px) {
    body { padding: 12px 8px 32px; }
    header.top .logo { font-size: clamp(20px, 6vw, 28px); }
    header.top .sub { font-size: clamp(12px, 2.8vw, 14px); }
    header.top .badges {
        display: flex;
        flex-wrap: wrap;
        justify-content: center;
    ...
    .steps-nav { gap: 0; }
    .step-item { min-width: 84px; padding: 10px 4px; }
    .step-item .num { width: 24px; height: 24px; line-height: 24px; font-size: 12px; }
    .step-item .lbl { font-size: 10px; }

    /* Wizard: acciones en columna */
    .actions { flex-direction: column-reverse; gap: 10px; }
    .actions .btn { width: 100%; justify-content: center; }
    .salva-row { flex-direction: column; align-items: stretch; }
    .salva-row .btn { width: 100%; }
    .salva-hint { text-align: center; }
    ...
    .modal-heading { margin-top: 8px; }
    .modal-logo { height: clamp(120px, 30vw, 180px); margin-top: 8px; }
    .modal-heading .hh { font-size: 18px; letter-spacing: 1px; }
    .modal-heading .ss { font-size: 12px; }
    .modal-heading .ss-copyright { font-size: 10.5px; }
    .modal-box { max-width: 100%; }
    .modal-body { padding: 18px 14px 20px; }
    .modal-box .actions { flex-direction: column; gap: 8px; }
    .modal-box .actions .btn { width: 100%; }
    ...
    /* Admin: opciones en columna */
    .admin-options { grid-template-columns: 1fr; gap: 10px; }
    .admin-opt { padding: 14px; }

    /* Log */
    .log-box { font-size: 11px; padding: 10px 12px; max-height: 160px; }
...
@media (max-width: 480px) {
    ...
    header.top .logo { font-size: clamp(17px, 5.5vw, 22px); }
    header.top .sub { font-size: 11.5px; }

    .wizard { border-radius: 10px; }
    .step-body { padding: 12px 10px 14px; }
    .panel-title { font-size: clamp(15px, 4vw, 18px); }
    .panel-desc { font-size: 12px; margin-bottom: 12px; }
    .card-info { font-size: 12px; padding: 10px 12px; }

    .steps-nav { scroll-snap-type: x mandatory; -webkit-overflow-scrolling: touch; }
    .step-item { min-width: 74px; padding: 8px 3px; scroll-snap-align: start; }
    .step-item .num { width: 22px; height: 22px; line-height: 22px; font-size: 11px; margin-bottom: 4px; }
    .step-item .lbl { font-size: 9.5px; line-height: 1.2; }
    ...
    .modal-logo { height: clamp(100px, 28vw, 150px); }
    .modal-heading .hh { font-size: 16px; }
    .modal-heading .ss { font-size: 11px; }
    .modal-heading .ss-copyright { font-size: 10px; }
    .modal-titlebar { padding: 10px 12px; }
    .modal-titlebar .tt-text { font-size: 13px; }
    .modal-close { width: 26px; height: 26px; font-size: 16px; }
    .modal-body { padding: 16px 12px 18px; }
    .modal-box h3 { font-size: 16px; }
    .modal-box p { font-size: 12.5px; }
    .modal-box .welcome-title { font-size: 15px; }
    .modal-box .welcome-sub { font-size: 12.5px; }
    .modal-box .form-control { padding: 8px 10px; font-size: 13px; }

    /* Admin */
    .admin-field label { font-size: 12px; }
    .admin-opt b { font-size: 13px; }
    .admin-opt span { font-size: 11.5px; }

    /* Footer */
    footer { padding: 12px 12px; font-size: 11px; }
    footer .fn { font-size: 12px; }
}

/* ---------- Móvil muy pequeño ---------- */
@media (max-width: 360px) {
    body { padding: 8px 4px 24px; }
    header.top .logo { font-size: 16px; }
    header.top .sub { font-size: 11px; }
    header.top .badges span { font-size: 9.5px; padding: 2px 8px; }

    .step-item { min-width: 64px; }
    .step-item .num { width: 20px; height: 20px; line-height: 20px; font-size: 10px; }
    .step-item .lbl { font-size: 9px; }

    .btn { padding: 8px 14px; font-size: 12px; }
    .form-control { padding: 7px 9px; font-size: 12.5px; }

    .modal-heading .hh { font-size: 14px; letter-spacing: .5px; }
    .modal-heading .ss { font-size: 10px; }
    .modal-logo { height: clamp(80px, 25vw, 120px); }
    .modal-box h3 { font-size: 14.5px; }

    .req-list li .rname { font-size: 12.5px; }
    .req-list li .val { font-size: 11.5px; }
    .req-list li .rdesc { font-size: 11px; }
    .req-list li .mysql-auth .form-control { font-size: 11.5px; }

    .log-box { font-size: 10.5px; padding: 8px 10px; }

    footer { font-size: 10.5px; }
    footer .fn { font-size: 11.5px; }
}

/* ---------- Accesibilidad ---------- */
@media (prefers-reduced-motion: reduce) {
    .bg, .bg2, .bg3, footer, .spin, #loader .spin,
    .alert .spin-icon, .strength-meter span { animation: none; transition: none; }
}

/* ---------- Fixes de desbordamiento ---------- */
html, body { overflow-x: hidden; }
.container, .wizard, .step-body, .step-panel,
.form-grid, .form-grid.grid-empresa, .summary, .req-list,
.modal-box, .modal-body, .admin-options { min-width: 0; }
.form-control, .btn, .step-item, .modal-heading .hh,
.modal-heading .ss, .modal-heading .ss-copyright,
.req-list li .val, .req-list li .rdesc,
.summary .item .v, .log-box, footer { word-break: break-word; overflow-wrap: anywhere; }

/* Las imágenes del logo no deben sobresalir */
.modal-logo { max-width: 100%; height: auto; object-fit: contain; }

/* Evitar que el nav de pasos se desborde sin scroll */
.steps-nav { -webkit-overflow-scrolling: touch; scrollbar-width: thin; }
.steps-nav::-webkit-scrollbar { height: 6px; }
.steps-nav::-webkit-scrollbar-thumb { background: rgba(255,255,255,.15); border-radius: 3px; }

/* ---------- Mejora táctil en móvil ---------- */
@media (hover: none) and (pointer: coarse) {
    .btn, .step-item, .modal-close, .password-toggle,
    .log-toggle, .admin-opt { min-height: 34px; }
    .btn-sm { min-height: 30px; }
    .modal-close { min-width: 30px; }
    .password-toggle { min-width: 30px; min-height: 30px; }
}
@media (max-width: 768px) {
    .modal-heading .modal-logo { height: clamp(150px, 32vw, 210px); }
}
@media (max-width: 480px) {
    .modal-heading .modal-logo { height: clamp(130px, 30vw, 180px); }
}
@media (max-width: 360px) {
    .modal-heading .modal-logo { height: 115px; }
}
</style>
</head>
