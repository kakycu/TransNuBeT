...
// Control de acceso por rol (exportación de solapines)
if (!permiso_puede('solapines', 'exportar')) {
    http_response_code(403);
    echo json_encode(['success' => false, 'message' => 'No tiene permisos suficientes para generar solapines. Contacte al administrador del sistema.']);
    exit;
}
