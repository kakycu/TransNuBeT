...
<style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .glass-card {
            ...
            padding: 24px; /* Genera un margen interno para separar el contenido de los bordes */
...
<div class="alert-guide fade-in-up" style="animation-delay: 0.05s;">
    <div class="guide-header">
        ...
        <button type="button" class="guide-close" onclick="this.closest('.alert-guide').style.display='none'">
    ...
    <div class="guide-body">
        ...
        <div class="guide-requirements">
            ...
            <div>
                ...
                <ul>
                    <li><i class="fas fa-check-circle" style="color: #4ade80;"></i> Nómina con estado <span class="badge-contabilizado">contabilizado</span></li>
                    <li><i class="fas fa-id-card" style="color: #60a5fa;"></i> Trabajadores con número de CI registrado (11 dígitos)</li>
                    <li><i class="fas fa-credit-card" style="color: #fbbf24;"></i> Trabajadores con Cuenta Bancaria registrada (14 o 16 dígitos)</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    .step {
        ...
        <div class="filters-container">
            <div class="filter-group">
                ...
                <select id="tipoNominaSelect" class="dark-select">
            ...
            <div class="filter-group">
                ...
                <select id="anioSelect" class="dark-select">
            ...
            <div class="filter-group">
                ...
                <select id="periodoSelect" class="dark-select">
...
<div class="cards-row">
    <div class="card-option" data-format="dbf">
        <i class="fas fa-database icon-option" style="color: #2563eb;"></i>
        <h5>DBF</h5>
        <p>dBase III PLUS</p>
    ...
    <div class="card-option" data-format="xlsx">
        <i class="fas fa-file-excel icon-option" style="color: #16a34a;"></i>
        <h5>Excel (XLSX)</h5>
        <p>Microsoft Excel</p>
    ...
    <div class="card-option" data-format="xml">
        <i class="fas fa-code icon-option" style="color: #d97706;"></i>
        <h5>XML</h5>
...
<!-- PANEL DE TOTALES - VERSIÓN COMPLETA -->
...
<div class="modal fade" id="modalPreview" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalPreviewLabel" aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content" style="background: rgba(20, 20, 28, 0.96); backdrop-filter: blur(20px); border: 1px solid rgba(96, 165, 250, 0.3); border-radius: 20px; color: #fff;">
            <div class="modal-header d-flex justify-content-between align-items-center" style="border-bottom: 1px solid rgba(96, 165, 250, 0.2);">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="dropdown-export-container">
                        <button class="btn-export-dropdown" id="exportDropdownBtn" style="background: rgba(30, 30, 45, 0.9); border: 1px solid rgba(96, 165, 250, 0.4); border-radius: 8px; padding: 6px 12px; color: white; cursor: pointer; display: flex; align-items: center; gap: 8px; font-size: 0.8rem;">
                            <i class="fas fa-download"></i>
                            <span>Exportar vista</span>
                            <i class="fas fa-chevron-down"></i>
                        </button>
                        <div class="dropdown-export-menu" id="exportDropdownMenu" style="position: absolute; top: 100%; right: 0; background: rgba(30, 30, 45, 0.98); backdrop-filter: blur(20px); border: 1px solid rgba(96, 165, 250, 0.3); border-radius: 12px; min-width: 180px; z-index: 1070; display: none; margin-top: 5px; box-shadow: 0 8px 32px rgba(0,0,0,0.4); overflow: hidden;">
                            <div class="dropdown-export-item" data-format="excel" style="padding: 10px 16px; display: flex; align-items: center; gap: 12px; cursor: pointer; transition: all 0.2s; color: white; font-size: 0.8rem;">
                                <i class="fas fa-file-excel" style="color: #22c55e; width: 20px;"></i>
                                <span>Excel (.xlsx)</span>
                            </div>
                            <div class="dropdown-export-item" data-format="word" style="padding: 10px 16px; display: flex; align-items: center; gap: 12px; cursor: pointer; transition: all 0.2s; color: white; font-size: 0.8rem; border-top: 1px solid rgba(255,255,255,0.1);">
                                <i class="fas fa-file-word" style="color: #3b82f6; width: 20px;"></i>
                                <span>Word (.docx)</span>
                            </div>
                            <div class="dropdown-export-item" data-format="pdf" style="padding: 10px 16px; display: flex; align-items: center; gap: 12px; cursor: pointer; transition: all 0.2s; color: white; font-size: 0.8rem; border-top: 1px solid rgba(255,255,255,0.1);">
                                <i class="fas fa-file-pdf" style="color: #ef4444; width: 20px;"></i>
                                <span>PDF (.pdf)</span>
                            </div>
                            <div class="dropdown-export-item" data-format="csv" style="padding: 10px 16px; display: flex; align-items: center; gap: 12px; cursor: pointer; transition: all 0.2s; color: white; font-size: 0.8rem; border-top: 1px solid rgba(255,255,255,0.1);">
                                <i class="fas fa-file-csv" style="color: #f59e0b; width: 20px;"></i>
                                <span>CSV (.csv)</span>
                            </div>
                            <div class="dropdown-export-item" data-format="txt" style="padding: 10px 16px; display: flex; align-items: center; gap: 12px; cursor: pointer; transition: all 0.2s; color: white; font-size: 0.8rem; border-top: 1px solid rgba(255,255,255,0.1);">
                                <i class="fas fa-file-alt" style="color: #9ca3af; width: 20px;"></i>
                                <span>TXT (.txt)</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer" style="border-top: 1px solid rgba(96, 165, 250, 0.2);">
...
async function imprimirPreview() {
    ...
    const empresa = nombreEmpresa || 'PDL TransNuBeT';
    ...
    htmlFinal += `
        <div class="page-sheet">
            ...
            <div style="font-size: 10pt; line-height: 1.6; margin-bottom: 25px; border-bottom: 1px solid #ddd; padding-bottom: 15px;">
            ...
            <div class="summary-container" style="flex-grow: 1;">
                ...
                <h3 style="font-size: 10.5pt; font-weight: bold; margin-bottom: 15px; color: #111;">1. RESUMEN FINANCIERO GENERAL</h3>
                
                <table style="width: 100%; border-collapse: collapse; font-size: 9.5pt; margin-bottom: 30px; line-height: 1.6;">
                    <!-- Fila Devengado General -->
                    <tr style="border-bottom: 2px solid #000; font-weight: bold;">
                        <td style="padding: 8px 0; color: #111;">TOTAL DEVENGADO GENERAL (NÓMINA COMPLETA)</td>
                        <td style="padding: 8px 0; text-align: right; font-size: 10pt;">${formatMoney(devengadoGeneralVal)}</td>
                    </tr>
                    
                    <!-- Bloque Trabajadores CON TARJETA -->
                    <tr style="font-weight: bold;">
                        <td style="padding: 10px 0 4px 0; color: #111;">TOTAL DEVENGADO GENERAL DE TRABAJADORES (CON TARJETA)</td>
                        <td style="padding: 10px 0 4px 0; text-align: right;">${formatMoney(devConTarjeta)}</td>
                    </tr>
                    <tr>
                        <td style="padding: 4px 0; color: #555; padding-left: 20px;">(-) Deducciones generales aplicadas (Trabajadores con Tarjeta)</td>
                        <td style="padding: 4px 0; text-align: right; color: #555;">${formatMoney(dedConTarjetaVal)}</td>
                    </tr>
                    <tr style="font-weight: bold; background-color: #f0f7ff; border-top: 1px dashed #004B87; border-bottom: 1px dashed #004B87;">
                        <td style="padding: 8px 10px; color: #004B87;">IMPORTE LÍQUIDO A ACREDITAR EN BANCO (BANDEC)</td>
                        <td style="padding: 8px 10px; text-align: right; color: #15803d; font-size: 10pt;">${formatMoney(acredVal)}</td>
                    </tr>
                    
                    <!-- Bloque Trabajadores SIN TARJETA -->
                    <tr style="font-weight: bold;">
                        <td style="padding: 12px 0 4px 0; color: #111;">TOTAL DEVENGADO GENERAL DE TRABAJADORES (SIN TARJETA)</td>
                        <td style="padding: 12px 0 4px 0; text-align: right;">${formatMoney(devSinTarjetaVal)}</td>
                    </tr>
                    <tr>
                        <td style="padding: 4px 0; color: #555; padding-left: 20px;">(-) Deducciones generales aplicadas (Trabajadores sin Tarjeta)</td>
                        <td style="padding: 4px 0; text-align: right; color: #555;">${formatMoney(dedSinTarjeta)}</td>
                    </tr>
                    <tr style="font-weight: bold; background-color: #fff5f5; border-top: 1px dashed #b91c1c; border-bottom: 2px solid #000;">
                        <td style="padding: 8px 10px; color: #b91c1c;">IMPORTE LÍQUIDO A PAGAR EFECTIVO</td>
                        <td style="padding: 8px 10px; text-align: right; color: #b91c1c; font-size: 10pt;">${formatMoney(efectivoVal)}</td>
                    </tr>
                </table>

                <!-- 2. DESGLOSE OPERATIVO DEL PERSONAL -->
                <h3 style="font-size: 10.5pt; font-weight: bold; margin-bottom: 15px; color: #111;">2. DESGLOSE OPERATIVO DEL PERSONAL</h3>
                
                <table style="width: 100%; border-collapse: collapse; font-size: 9.5pt; margin-bottom: 30px; line-height: 1.6;">
                    <tr style="border-bottom: 1px solid #eee;">
                        <td style="padding: 8px 0; color: #333;">Trabajadores procesados para depósito electrónico (con tarjeta activa)</td>
                        <td style="padding: 8px 0; text-align: right; font-weight: bold;">${conTarjetaCountVal}</td>
                    </tr>
                    <tr style="border-bottom: 1px solid #eee;">
                        <td style="padding: 8px 0; color: #333;">Trabajadores pendientes de bancarización (pago manual por ventanilla)</td>
                        <td style="padding: 8px 0; text-align: right; font-weight: bold;">${sinTarjetaCountVal}</td>
                    </tr>
                    <tr style="font-weight: bold; background-color: #f8fafc; border-top: 1.5px solid #000; border-bottom: 1.5px solid #000;">
                        <td style="padding: 10px 8px; color: #000;">TOTAL DE TRABAJADORES EVALUADOS EN EL PERÍODO</td>
                        <td style="padding: 10px 8px; text-align: right; color: #000; font-size: 10pt;">${totalNominaCountVal}</td>
                    </tr>
                </table>
            </div>

            <!-- Firmas de Autorización -->
            <div class="signatures-area" style="display: flex; justify-content: space-between; margin-top: 60px; padding: 0 10px;">
                <div style="width: 42%; text-align: center;">
                    <p style="font-size: 8.5pt; color: #555; margin-bottom: 55px;">Elaborado por:</p>
                ...
                <div style="width: 42%; text-align: center;">
                    <p style="font-size: 8.5pt; color: #555; margin-bottom: 55px;">Aprobado por:</p>
                    <div style="border-top: 1.5px solid #000; width: 90%; margin: 0 auto; padding-top: 6px;">
        ...
        <head>
            ...
            <style>
                * { margin: 0; padding: 0; box-sizing: border-box; }
                ...
                .logo-area img { max-height: 60px; max-width: 100%; width: auto; }
                .header-text { text-align: center; width: 60%; }
                .header-text h1 { font-size: 12pt; color: #004B87; margin: 0; text-transform: uppercase; }
                .header-text h2 { font-size: 9.5pt; color: #333; margin: 2px 0 0; }
                .header-text p { font-size: 8pt; color: #555; margin: 2px 0 0; }
                ...
                .print-table th, .print-table td { border: 1px solid #b3b3b3; padding: 3px 6px; line-height: 1.2; }
                .print-table th { 
    ...
    let excelTemplate = `
        ...
        <head>
            ...
            <style>
                ...
                .header-text p { font-size: 8pt; color: #555; margin: 2px 0 0; }
                .header-right { width: 25%; text-align: right; font-size: 8pt; color: #555; line-height: 1.3; }
                .section-title { font-size: 10pt; font-weight: bold; color: #004B87; margin: 20px 0 8px 0; font-family: Arial; }
                .section-title-sin { font-size: 10pt; font-weight: bold; color: #b91c1c; margin: 20px 0 8px 0; font-family: Arial; }
                table.data-table { border-collapse: collapse; width: 100%; font-size: 8.5pt; margin-bottom: 10px; }
                table.data-table th, table.data-table td { border: 1px solid #b3b3b3; padding: 4px 6px; }
    ...
    let wordTemplate = `
        ...
        <head>
            ...
            <style>
                ...
                .logo-area { width: 60px; }
                .logo-area img { max-height: 40px; max-width: 55px; width: auto; height: auto; }
                .header-text { text-align: center; width: 60%; }
                .header-text h1 { font-size: 12pt; color: #004B87; margin: 0; text-transform: uppercase; }
                .header-text h2 { font-size: 9.5pt; color: #333; margin: 2px 0 0; }
                .header-text p { font-size: 8pt; color: #555; margin: 2px 0 0; }
                .header-right { width: 25%; text-align: right; font-size: 8pt; color: #555; line-height: 1.3; }
                .section-title { font-size: 10pt; font-weight: bold; color: #004B87; margin: 20px 0 8px 0; }
                .section-title-sin { font-size: 10pt; font-weight: bold; color: #b91c1c; margin: 20px 0 8px 0; }
                table.data-table { width: 100%; border-collapse: collapse; font-size: 8.5pt; margin-top: 8px; }
                table.data-table th, table.data-table td { border: 1px solid #b3b3b3; padding: 4px 6px; }
                table.data-table th { background-color: #004B87; color: #ffffff; font-weight: bold; text-transform: uppercase; font-size: 7.5pt; }
                table.data-table-sin th { background-color: #b91c1c; color: #ffffff; font-weight: bold; text-transform: uppercase; font-size: 7.5pt; }
                .total-row-con { background-color: #e6f0ff; font-weight: bold; }
        ...
        <body>
            ...
            <table class="data-table">
                <thead>
                    <tr>
                        <th align="center" style="width: 45px;">No.</th>
                        <th align="center" style="width: 90px;">CI / NID</th>
                        <th align="left">Nombre del Trabajador</th>
                        <th align="center" style="width: 120px;">Cuenta Bancaria</th>
                        <th align="right" style="width: 80px;">Importe (CUP)</th>
                    </tr>
                </thead>
                <tbody>
    `;
            ...
            <table class="data-table">
                <thead>
                    <tr>
                        ...
                        <th align="center" style="width: 90px;">CI / NID</th>
                        <th align="left">Nombre del Trabajador</th>
                        <th align="center" style="width: 120px;">Vía de Pago</th>
                        <th align="right" style="width: 80px;">Importe (CUP)</th>
                    </tr>
                </thead>
                <tbody>
        ...
        if (data.success) {
            ...
            if (comprimirZip) {
                                ...
                                Swal.fire({
                                    ...
                                    html: `
                                        <div style="text-align: center;">
                                            <i class="fas fa-file-archive" style="font-size: 48px; color: #60a5fa; margin-bottom: 16px;"></i>
                ...
                Swal.fire({
                    ...
                    html: `
                        <div style="text-align: center;">
                            <i class="fas fa-file-alt" style="font-size: 48px; color: #34D399; margin-bottom: 16px;"></i>
...
textCell.style.paddingRight = '15px';
...
importeCell.style.paddingRight = '15px';
            ...
            if (previewAdvertencia) previewAdvertencia.innerHTML = '<i class="fas fa-exclamation-triangle"></i> No hay trabajadores con tarjeta y CI en este período. No se puede exportar.';
            if (previewTableBodyElem) previewTableBodyElem.innerHTML = '<tr><td colspan="3" class="text-center text-muted">No hay registros válidos</td></tr>';
        ...
        if (data.success && data.contabilizada) {
            ...
            Swal.fire({
                ...
                html: `<p>La nómina de tipo <strong>${tipoNomina}</strong> para el período <strong>${nombreMes}/${desdeParts[0]}</strong> no está contabilizada.</p>
                       <p>Para exportar al banco, la nómina debe estar en estado <strong style="color: #4ade80;">"contabilizado"</strong>.</p>
                       <hr>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (cards.length > 0) {
        cards.forEach(card => {
            card.addEventListener('click', function(e) {
                ...
                window.formatoSeleccionado = this.getAttribute('data-format');
                const formatoSeleccionadoInput = document.getElementById('formatoSeleccionado');
            ...
            const checkbox = card.querySelector('.zip-checkbox');
            if (checkbox) {
    ...
    // Exclusión mutua de checkboxes ZIP
        ...
        confirmExportBtn.addEventListener('click', function() {
            if (window.previewData) {
                ...
                Swal.fire({
                    ...
                    text: 'No se puede exportar porque no hay trabajadores con tarjeta y CI en el período seleccionado.',
                    confirmButtonText: 'Entendido'
                });
            }
        });
