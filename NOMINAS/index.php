        ...
        body::after {
            ...
            background-image: 
                ...
                repeating-linear-gradient(
                    ...
                    transparent,
                    transparent 35px,
                    rgba(139, 92, 246, 0.06) 35px,
                    rgba(139, 92, 246, 0.06) 70px
                );
            pointer-events: none;
...
<div class="dashboard-container">
        ...
        <div class="brand-card">
            ...
            <div class="brand-footer">
                ...
                <div class="footer-badge">
                    ...
                    <span>Licencia Shareware v2.0</span>
                </div>
                
                <!-- Separador y enlaces legales -->
                <div class="footer-divider"></div>
                <div class="footer-badge" style="gap: 12px;">
                    <a href="../terminos.php" style="color: #94a3b8; text-decoration: none; display: inline-flex; align-items: center; gap: 5px; font-size: 0.7rem; transition: 0.2s;">
                        <i class="fas fa-file-contract"></i> Términos
                    </a>
                    <span style="color: #475569;">|</span>
                    <a href="../privacidad.php" style="color: #94a3b8; text-decoration: none; display: inline-flex; align-items: center; gap: 5px; font-size: 0.7rem; transition: 0.2s;">
                        <i class="fas fa-lock"></i> Privacidad
                    </a>
                    <span style="color: #475569;">|</span>
                    <a href="../soporte.php" style="color: #94a3b8; text-decoration: none; display: inline-flex; align-items: center; gap: 5px; font-size: 0.7rem; transition: 0.2s;">
    ...
    <div style="text-align: center; margin-top: 16px; padding: 12px; font-size: 0.7rem; color: #5a6a8a;">
        <div class="copyright-logo">
            ...
            <span style="font-weight:bold;font-size:14px;color:white;">Copyright © <?php echo $current_year; ?> UnicornioSoftware° - Kaky&reg;. Todos los derechos reservados.</span>
        </div>
    </div>
</div>
...
function verificarEstadoConLoading() {
    Swal.fire({
        ...
        html: `<div style="text-align:center;"><div class="loading-spinner-small"></div><p style="margin-top:15px;">Comprobando conexión con el servidor...</p></div>`,
        background: '#0f172a',
        color: '#e2e8f0',
...
if (accessButton) {
    accessButton.addEventListener('click', (e) => {
        ...
        window.location.href = '/nominas/login.php';
    });
}
...
if (infoModern) {
    infoModern.addEventListener('click', () => {
        const mysqlStatus = serverStatus.mysql ? 
            '<span style="color:#22c55e;"><i class="fas fa-check-circle"></i> Conectado</span>' : 
        ...
        Swal.fire({
            ...
            html: `
            <div style="text-align: left; max-height: 360px; overflow-y: auto; padding-right: 8px;">
                ...
                <p style="text-align: center; font-size: 0.75rem; color: #6b7a9a;">
                    <img src="../images/logounicornio.png" alt="UnicornioSoftware" style="width: 16px; height: 16px; vertical-align: middle; margin-right: 4px;" onerror="this.style.display='none'">
        ...
        if (serverStatus.php && serverStatus.mysql) {
            Swal.fire({
                ...
                html: `<div style="text-align:left;">
                        ...
                        <p><strong>Base de datos:</strong> TransNuBeT_nomina</p>
