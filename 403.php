...
@media (max-width: 360px) {
    ...
    .error-header h2 { font-size: 15px; }
}
    ...
    <div class="wizard">
        ...
        <div class="step-body">
            ...
            <div class="alert error show">
                ...
                Si cree que se trata de un error, contacte al administrador del sitio.
            </div>

            <h2 class="panel-title">Acceso Denegado</h2>
            <p class="panel-desc">
                El servidor ha denegado la solicitud porque no cuenta con permisos suficientes
            ...
            <div class="info-grid">
                ...
                <div class="info-box">
                    ...
                    <div class="data-row">
                        <span class="data-label">Permisos del archivo:</span>
                        <span class="data-value">CHMOD 644</span>
                    </div>
                    <div class="data-row">
                        <span class="data-label">Restricciones:</span>
                        <span class="data-value">.htaccess</span>
                    </div>
                    <div class="data-row">
                        <span class="data-label">Directorio protegido:</span>
                        <span class="data-value">Listado bloqueado</span>
                    </div>
                </div>
            </div>
